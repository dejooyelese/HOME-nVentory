...
CREATE TABLE IF NOT EXISTS `homeinventorydb`.`users` (
  ...
  `ResetPasswordUUID` VARCHAR(50) DEFAULT NULL,
  `RegistrationUUID` VARCHAR(50) DEFAULT NULL,
...
INSERT INTO `users` (`Username`,`Password`,`Email`,`FirstName`,`LastName`,`Active`,`IsAdmin`) VALUES ('carl','password','cprg352+carl@gmail.com','Carl','Carlton',0,0);
INSERT INTO `users` (`Username`,`Password`,`Email`,`FirstName`,`LastName`,`Active`,`IsAdmin`) VALUES ('don','password','cprg352+don@gmail.com','Don','Donberg',0,0);
